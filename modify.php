        ...
        <div class="container-fluid">
            <div class="form-group">
                <form action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>" method="post" class="cnx formulaireLogin">
                    ...
                    <input class="btnSubmit btn btn-primary" type="submit" value="Valider">
                    <button class="btnSubmit btn btn-secondary" value="Annuler"><a href='./profil.php'>Annuler</a></button>
